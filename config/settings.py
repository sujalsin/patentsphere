...
class LLMConfig(BaseModel):
    ...
    timeout: int = 120
    num_ctx: int = 8192  # Context window size for Ollama
...
class ChunkingConfig(BaseModel):
    ...
    # Hybrid/semantic chunking settings
    semantic_chunk_size: int = 350
    min_chunk_size: int = 100
    max_chunk_size: int = 500
    split_threshold: int = 400
...
def create_settings_from_yaml(yaml_config: Dict[str, Any]) -> Settings:
    ...
    return Settings(
        ...
        llm=LLMConfig(
            ...
            num_ctx=llm_config_data.get('ollama', {}).get('num_ctx', 8192),
            models=llm_models,
